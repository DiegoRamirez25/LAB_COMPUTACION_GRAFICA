...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados | Diego Ramirez | 319296738 ", nullptr, nullptr);
...
void Animation() {
	...
	if (dogAnim == 1) {
		...
		// Movimiento de ida y vuelta con velocidad aumentada
